    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 lg:flex-col lg:justify-between bg-gradient-to-br from-primary-700 via-primary-800 to-primary-900 p-12">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-2xl font-bold text-white">Ndiipano</span>
        </Link>
        <div>
          ...
          <p className="mt-4 text-lg text-gray-300">
            ...
            looking to serve your community, Ndiipano connects you with the
            right people.
          </p>
        ...
        <p className="text-sm text-gray-400">
          &copy; {new Date().getFullYear()} Ndiipano Medical Home Care
        </p>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8 lg:hidden">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-primary-700">Ndiipano</span>
            </Link>
          </div>
          {children}
        </div>
