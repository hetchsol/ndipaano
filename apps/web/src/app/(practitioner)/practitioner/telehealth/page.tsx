...
export default function PractitionerTelehealthSessionsPage() {
  ...
  return (
    <div className="animate-fade-in">
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-gray-500">Manage your virtual consultation sessions</p>
      </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-900">
                        {session.booking.patient.firstName} {session.booking.patient.lastName}
                      </p>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    ...
                    {session.status === 'WAITING' && (
                      <Button
                        size="sm"
                        onClick={() => router.push(`/practitioner/telehealth/${session.id}`)}
                      >
                        Start Call
                      </Button>
                    )}
